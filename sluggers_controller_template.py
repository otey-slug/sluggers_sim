...
def obstacle_avoidance_turn(ping):
...
def drive_to_isz_with_ping(sensors):
    ...
    avoid_turn = obstacle_avoidance_turn(ping)
    ...
    avoid_weight = clamp((SLOW_RANGE_IN - nearest_front) / SLOW_RANGE_IN, 0.0, 1.0)
